...
| Business relevance | 0–100 | `config/business.yaml` embeddings + human override (§8) | — | any human override |
| Gap opportunity | 0–100 | demand vs coverage (`02-insights/competitor-gaps.md §4`) | 5 authors, demand ≥45 | every `silent` gap |
